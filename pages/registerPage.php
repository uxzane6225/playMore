...
$_SESSION['title'] = "Registration Page";
    ...
    <form action="../processors/auth/auth.php" method="POST" class="w-full flex flex-col items-center justify-evenly text-white bg-red-500 lg:w-3/6">
        ...
        <div class="px-10 w-full flex flex-col gap-3 text-xl">
            <div class="flex flex-col gap-1">
                <label for="email" class="pl-2">Full Name</label>
                <input type="text" id="name" name="name" class="p-1.5 text-black rounded-lg border outline-none lg:border-gray-400 lg:focus:outline-red-400" autocomplete="email"" required>
            </div>
            <div class="flex flex-col gap-1">
            ...
            <div class="flex flex-col gap-1">
                <label for="email" class="pl-2">Home Address</label>
                <input type="text" id="name" name="name" class="p-1.5 text-black rounded-lg border outline-none lg:border-gray-400 lg:focus:outline-red-400" autocomplete="email"" required>
            </div>
            <div class="flex flex-col gap-1">
