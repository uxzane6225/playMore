...
$_SESSION['title'] = "Create Admin/Employee";
...
<main class="p-5 lg:col-span-4 h-full w-full flex flex-col gap-5">
    <div class="flex gap-5 items-center">
        <h2 class="text-4xl font-bold">Create Admin/Employee</h2>
    ...
    <form action="../../processors/users/add.php" method="POST" class="flex flex-col text-md gap-3">
