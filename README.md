...
## Minimum Technical Requirements
 1. Custom Login Page (check)
 2. Custom Registration Page (check)
 3. Custom Dashboard (check [bland])
 4. Session-Based Authentication (check)
 5. Role-Based Authorization (check)
 6. Protected Pages (check)
 7. Session Timeout (check)
 8. CRUD Module (check)
 9. Administrator-Only Delete Functionality (check [staff role can delete sale details])
